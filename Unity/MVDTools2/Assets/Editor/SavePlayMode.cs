...
public class SavePlayMode
{
    ...
    static void ReplaceComponents(GameObject original, GameObject prefab)
    {
        ...
        // Instantiate the copy of my gameobject which has the values that I changed in play mode.
        ...
        ctx_copy_object.transform.SetSiblingIndex(original.transform.GetSiblingIndex()); // Gameobject in the hierarchy is in the same position
