...
void Game::init(int w, int h) {
    ...
    ball_mesh.geometry = graphics_system_.createGeometryFromFile("data/assets/teapot_small.obj");
	...
	ball2_mesh.geometry = graphics_system_.createGeometryFromFile("data/assets/teapot_small.obj");
    ...
    Parsers::parseAnimation("data/assets/bounce1.anim");
